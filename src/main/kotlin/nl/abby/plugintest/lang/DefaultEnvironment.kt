...
import nl.abby.plugintest.lang.Package.Companion.AMSMATH
import nl.abby.plugintest.psi.LatexEnvironment
import nl.abby.plugintest.util.name
import java.util.*
...
enum class DefaultEnvironment(
    ...
    EQUATION(environmentName = "equation", context = Environment.Context.MATH),
    ...
    LIST(
        ...
        RequiredArgument("spacing"), environmentName = "list"),
    LRBOX(environmentName = "lrbox"),
    MATH(environmentName = "math"),
    MINIPAGE(
        OptionalArgument("position"),
        RequiredArgument("width"), environmentName = "minipage"),
